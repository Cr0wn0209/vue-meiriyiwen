<template lang="html">
  <div>
    <articlecontainer v-on:isloading="handleloadingflag" v-on:loaded="handleloaded" v-on:getDate="handleDate" datafrom="0"></articlecontainer>
    ...
    <sidemenu v-if="sidemenuOpen_display" v-bind:sidemenuState="sidemenuOpen" v-on:sidemenuClose="sidemenuSwitch(0)" father="home" v-bind:articleDate="articleDate"></sidemenu>
  </div>
</template>
